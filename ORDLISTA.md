...
`data/ordlista.json` innehåller **10 941 poster och 0 stubs** (mätt 2026-08-03). Varje
...
Mät aldrig detta på känsla; kör snutten under tabellen. **Siffrorna gäller alla 10 941
...
|---|---:|---:|---:|
| Ordklasstagg | 10 941 | 100 % | 0 |
| `Eng. ` | 9 684 | 88,5 % | 1 257 |
| Etymologi (`Av lat./gr. …`) | 7 716 | 70,5 % | 3 225 |
| `Sv. ` | 2 631 | 24,0 % | 8 310 |
| Böjning i parentes | 4 696 | 42,9 % | 6 245 |
| `Jfr ` | 1 392 | 12,7 % | 9 549 |
| `ICD-10: ` | 944 | 8,6 % | 9 997 |
| `Vardag. ` | 781 | 7,1 % | 10 160 |
| `Se ` | 357 | 3,3 % | 10 584 |
| `Motsats` | 157 | 1,4 % | 10 784 |
| `Referensvärde` | 78 | 0,7 % | 10 863 |
| Uttalsangivelse | **0** | 0,0 % | 10 941 |
...
**Inga formavvikelser kvar (0.9.342):** samtliga 10 941 poster inleds med en gement
...
Så ser de 10 941 posterna faktiskt ut: **ordklasstaggen först**, böjningen i parentes direkt
...
bl.a. att båda stegen ger identiska länkar för var och en av de 10 941 posterna, att
